# IO.Swagger.Api.MocksAndTestsApi
...
namespace Example
{
    public class CheckCategorizationExample
    {
        public void main()
        {
            ...
            var apiInstance = new MocksAndTestsApi();
            var body = new CheckCategorizationData(); // CheckCategorizationData | Transactions data
            ...
            {
                Debug.Print("Exception when calling MocksAndTestsApi.CheckCategorization: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class MockBatchUpdateExample
    {
        public void main()
        {
            ...
            var apiInstance = new MocksAndTestsApi();
            var body = new MockBatchUpdateParams(); // MockBatchUpdateParams | Data for mock bank connection updates
            ...
            {
                Debug.Print("Exception when calling MocksAndTestsApi.MockBatchUpdate: " + e.Message );
            }
        }
    }
}
