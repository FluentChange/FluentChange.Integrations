...
namespace IO.Swagger.Model {
  ...
  public class ImportBankConnectionParams {
    ...
    /// </summary>
    /// <value>Custom name for the bank connection. Maximum length is 64. If you do not want to set a name, you can leave this field unset.</value>
