...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class DirectDebitOrderParams {
    /// <summary>
    ...
    /// </summary>
    /// <value>The amount of the payment. Must be a positive decimal number with at most two decimal places. When debiting money using the FINTS_SERVER or WEB_SCRAPER interface, the currency is always EUR.</value>
    ...
    /// </summary>
    /// <value>Mandate ID that this direct debit order is based on.</value>
    ...
    /// </summary>
    /// <value>Date of the mandate that this direct debit order is based on, in the format 'YYYY-MM-DD'</value>
    [DataMember(Name="mandateDate", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "mandateDate")]
    public string MandateDate { get; set; }

    /// <summary>
    /// Creditor ID of the source account's holder
    /// </summary>
    /// <value>Creditor ID of the source account's holder</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class DirectDebitOrderParams {\n");
