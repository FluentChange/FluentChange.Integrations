...
namespace IO.Swagger.Model {
  ...
  public class UpdateMultipleTransactionsParams {
    ...
    /// </summary>
    /// <value>A comma-separated list of transaction identifiers. If specified, then only transactions whose identifier match any of the given identifiers will be regarded. The maximum number of identifiers is 100.</value>
    ...
    /// </summary>
    /// <value>A comma-separated list of account identifiers. If specified, then only transactions whose account's identifier is included in this list will be regarded.</value>
